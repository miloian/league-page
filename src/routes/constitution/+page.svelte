...
<div class="constitution">
    ...
    <div class="subBlock">
        <p>Any player traded from a team may not be re-acquired via trade within the season of the original trade. Any teams involved in this behavior will be subject to the aforementioned collusion punishments.</p>
    </div>
    ...
    <div class="subBlock">
        <p>No vetos. If the comissioner feels input is needed people will be contacted for input.</p>
    </div>

    <h3 bind:this={oneThree}>1.3 Waiver Wire</h3>

    <p>FAAB Waiver wire system. Each team will begin the season with $300. $0 bids are not allowed.</p>
    ...
    <p>Picks 12-5 will be in reverse order of the previous seasons standings. Picks 1-4 will be determined in a lottery drawing based on Toilet Bowl results.</p>
    ...
    <p>League dues are set at {dues}$. All managers must be fully paid up before the start of regular season.</p>

    <h3 bind:this={sevenTwo}>7.2 Payout</h3>
    <p>League payout is structured as follows: UPDATE NOT VALID RIGHT NOW</p>
    <ul>
